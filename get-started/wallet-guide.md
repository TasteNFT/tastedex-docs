...
![](../.gitbook/assets/docs%20masthead%20\(9\).png)

To get started on TasteDEX, the first thing you'll need is to set up a wallet that supports BNB Smart Chain (BSC). Wallets are available both on desktop computers and on smartphone devices. You'll need to choose the wallet that fits your needs best.
...
This comparison table gives an overview of the most popular mobile wallets used with TasteDEX.
...
* Additional steps needed to use with BNB Smart Chain and TasteDEX
...
To connect to BNB Smart Chain and use TasteDEX, you can follow the TokenPocket section of our Connect Your Wallet to TasteDEX guide [https://docs.TasteDEX.finance/get-started/connection-guide](https://docs.TasteDEX.finance/get-started/connection-guide).
...
The genuine TasteDEX site and staff will never ask you to input your seed phrase.\*\*
{% endhint %}
...
This comparison table gives an overview of the most popular desktop wallets used with TasteDEX.
...
* Supports BNB Smart Chain by default, making using TasteDEX easy
* Supports a large number of languages
* Hardware wallet compatible
...
And that’s it, all done! You can follow our [Connect Your Wallet to TasteDEX guide](https://docs.TasteDEX.finance/get-started/connection-guide) to connect to BNB Smart Chain and TasteDEX.
{% endtab %}
{% endtabs %}
